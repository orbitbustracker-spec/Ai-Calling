...
export default async function AiTelephonyEnginePage() {
  ...
  return (
    <div className="p-8 h-full overflow-y-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-slate-900 dark:text-slate-900 dark:text-white flex items-center gap-3">
        ...
        <p className="text-slate-500 dark:text-slate-500 dark:text-slate-400 mt-2">Manage Global AI Nodes and Assign them to Organizations.</p>
      </div>
