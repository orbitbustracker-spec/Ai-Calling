      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              <label className="block text-sm font-medium text-gray-700">Email Address (baraldhar@gmail.com)</label>
          ...
          <div className="mt-6 text-xs text-center text-gray-500">
            Note: Phone number login (9851049147) requires an active SMS Gateway (e.g. Twilio) in Supabase. Please use Email & Password for now.
          </div>
        </div>
      </div>
    </div>
